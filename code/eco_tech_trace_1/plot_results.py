...
def main() -> None:
    ...
    plt.xlabel("Time (UTC)")
    plt.ylabel("Cumulative unique (dst_MAC, VLAN)")
    plt.title("Cumulative unique (dst_MAC, VLAN)")
    ...
    plt.xlabel("Time (UTC)")
    plt.ylabel("Cumulative unique (dst_MAC, VLAN, dst_port)")
    plt.title("Cumulative unique (dst_MAC, VLAN, dst_port)")
    plt.xticks(rotation=45)
    plt.tight_layout()
    ...
    plt.xlabel("Time (UTC)")
    plt.ylabel("New pairs per second")
    plt.title("Insert operations per second: new (dst_MAC, VLAN)")
    plt.xticks(rotation=45)
    plt.tight_layout()
    ...
    plt.xlabel("Time (UTC)")
    plt.ylabel("New pairs per 5 seconds")
    plt.title("Insert operations per 5 seconds: new (dst_MAC, VLAN)")
    plt.xticks(rotation=45)
    plt.tight_layout()
    ...
    plt.title("Find operations per second")
    plt.xticks(rotation=45)
    plt.tight_layout()
    ...
    plt.xlabel("Time (UTC)")
    plt.ylabel("Requests per 5 seconds")
    plt.title("Find operations per 5 seconds")
    plt.xticks(rotation=45)
    plt.tight_layout()
