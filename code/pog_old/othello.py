...
class Othello(HashAlgorithmBase):
    def __init__(self, ma, mb, ha, hb, a, b):
        ...
        print(f'OLD: Othello structure with ma={ma}, mb={mb}, hash_size={self.hash_size}')
    ...
    def search(self, key):
        ...
        self.metrics.inc("hash_calls_total", 2)
        self.metrics.inc("memory_count", 2)
                ...
                if (self.g.nodes[u]['color'] != self.g.nodes[v]['color'] and t_k == 0) or (
                    ...
                    if u not in already_seen:
                        ...
                        if self.b[j]:
                            ...
                            self.g.nodes[v]['color'] = 'white'
                        info.memory += 3
                        self.metrics.inc("memory_count", 3)
                already_seen.add(u)
                already_seen.add(v)
